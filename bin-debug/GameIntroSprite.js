var GameIntroSprite = (function (_super) {
    __extends(GameIntroSprite, _super);
    function GameIntroSprite() {
        _super.call(this);
        this.FONT_SHADOW_SIZE = 21;
        this.FONT_SIZE = 16;
        this.LINE_GAP = 19;
        ...
        var introPanelBg = new egret.Bitmap(RES.getRes("images.gameintropanelbg"));
        ...
        var introTitleShadow = new egret.TextField();
        ...
        var introTitle = new egret.TextField();
        ...
        var textIntroContent = new egret.TextField();
    ...
    var d = __define,c=GameIntroSprite,p=c.prototype;
    p.removeFromStage = function (e) {
        this.parent.removeChild(this);
    };
    return GameIntroSprite;
}(egret.Sprite));
egret.registerClass(GameIntroSprite,'GameIntroSprite');
