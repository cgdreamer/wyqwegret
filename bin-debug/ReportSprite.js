var ReportSprite = (function (_super) {
    __extends(ReportSprite, _super);
    function ReportSprite() {
        _super.call(this);
        this.fontSz = 19;
        this.positions = [[{ x: 190, y: 87, w: 123, h: 51 }, { x: 490, y: 87, w: 118, h: 51 }], [{ x: 190, y: 140, w: 123, h: 51 }, { x: 490, y: 140, w: 118, h: 51 }], [{ x: 190, y: 194, w: 123, h: 51 }, { x: 490, y: 194, w: 118, h: 51 }]];
        ...
        returnBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) { GlobalModel.main.commitRecord(); GlobalModel.main.changeToSceneByName("StartScene"); }, this);
        returnBtn.x = 113;
        returnBtn.y = 283;
        this.addChild(returnBtn);
        var detailBtn = new SimpleButton("images.showdetailbtnup", "images.showdetailbtnover");
        detailBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) { GlobalModel.main.getSceneByName("PlayScene")["showDetailSprite"](true); }, this);
        detailBtn.x = 277;
        detailBtn.y = 283;
        ...
        this.continueBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function (e) { GlobalModel.main.getSceneByName("PlayScene")["resumePlay"](); }, this);
        this.addChild(this.continueBtn);
    }
    var d = __define,c=ReportSprite,p=c.prototype;
    ...
    p.refresh = function (isPlayEnd) {
        if (isPlayEnd === void 0) { isPlayEnd = false; }
